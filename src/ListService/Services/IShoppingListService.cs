...
public interface IShoppingListService
{
    ...
    Task<ListResponse?> UpdateAsync(string ownerId, string id, Guid expectedVersion, UpdateListRequest request, CancellationToken cancellationToken = default);
    Task<bool> DeleteAsync(string ownerId, string id, Guid expectedVersion, CancellationToken cancellationToken = default);
}
